...
test("hrvst reports time-reports tasks-time-report", async () => {
  const { stdout } = await execaCommand(
    "node dist/cli.js reports time-reports tasks-time-report --help",
  );
  expect(stdout).toMatchInlineSnapshot(`
    "cli.js reports time-reports tasks-time-report

    Tasks Time Report shows the hours and billable information for each task where
