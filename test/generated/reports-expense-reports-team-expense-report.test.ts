...
test("hrvst reports expense-reports team-expense-report", async () => {
  const { stdout } = await execaCommand(
    "node dist/cli.js reports expense-reports team-expense-report --help",
  );
  expect(stdout).toMatchInlineSnapshot(`
    "cli.js reports expense-reports team-expense-report

    Team Expense Report shows expense totals for each user where expenses are
