  ...
  expect(stdout).toMatchInlineSnapshot(`
    ...
    Options:
      ...
      -c, --client_id                 The ID of the client this invoice belongs to.
                                                                          [required]
      -r, --retainer_id               The ID of the retainer associated with this
                                      invoice.
      -e, --estimate_id               The ID of the estimate associated with this
                                      invoice.
      -n, --number                    If no value is set, the number will be
                                      automatically generated.
      -p, --purchase_order            The purchase order number.
      -t, --tax                       This percentage is applied to the subtotal,
                                      including line items and discounts. Example:
                                      use 10.0 for 10.0%.
      -a, --tax2                      This percentage is applied to the subtotal,
                                      including line items and discounts. Example:
                                      use 10.0 for 10.0%.
      -d, --discount                  This percentage is subtracted from the
                                      subtotal. Example: use 10.0 for 10.0%.
      -s, --subject                   The invoice subject.
      -o, --notes                     Any additional notes to include on the
                                      invoice.
      -u, --currency                  The currency used by the invoice. If not
                                      provided, the client’s currency will be used.
                                      See a list of supported currencies
      -i, --issue_date                Date the invoice was issued. Defaults to
                                      today’s date.
          --due_date                  Date the invoice is due. Defaults to the
                                      issue_date if no payment_term is specified.
      -y, --payment_term              The timeframe in which the invoice should be
                                      paid. Defaults to custom. Options: upon
                                      receipt, net 15, net 30, net 45, or net 60.
      ...
      -x, --line_items[0]taxed        Whether the invoice’s tax percentage applies
                                      to this line item.
      ...
      -k, --line_items[1]kind         The name of an invoice item category.
          ...
          --line_items[1]taxed        Whether the invoice’s tax percentage applies
                                      to this line item.
