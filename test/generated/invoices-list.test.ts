...
test("hrvst invoices list", async () => {
  ...
  expect(stdout).toMatchInlineSnapshot(`
    ...
    Options:
      ...
      -c, --client_id      Only return invoices belonging to the client with the
                           given ID.
      -p, --project_id     Only return invoices associated with the project with the
                           given ID.
      -u, --updated_since  Only return invoices that have been updated since the
                           given date and time.
      -f, --from           Only return invoices with an issue_date on or after the
                           given date.
      -t, --to             Only return invoices with an issue_date on or before the
                           given date.
      -s, --state          Only return invoices with a state matching the value
                           provided. Options: draft, open, paid, or closed.
