...
test("hrvst expenses update", async () => {
  ...
  expect(stdout).toMatchInlineSnapshot(`
    ...
    Options:
      ...
      -x, --expense_category_id  The ID of the expense category this expense is
                                 being tracked against.
      -s, --spent_date           Date the expense occurred.
      -u, --units                The quantity of units to use in calculating the
      ...
      -d, --delete_receipt       Whether an attached expense receipt should be
                                 deleted. Pass true to delete the expense receipt.
