...
const readmeTemplate = path.join("scripts", "README-template.md");
...
/**
 * Override default API parameter descriptions
 */
...
/**
 * Substitute variables in scripts/README-template.md and copy to the root of the
  ...
  url: ((r) => {
    const prepareParams = (
      ...
      variables?.forEach((v: QueryParamDefinition | VariableDefinition) => {
        ...
        if (v.key && v.key in descriptionOverrides) {
          v.description = descriptionOverrides[v.key];
        }
      });
